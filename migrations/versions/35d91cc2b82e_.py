...
Revision ID: 35d91cc2b82e
Revises: 06538e3ffe31
Create Date: 2022-08-20 04:20:18.779990
...
revision = '35d91cc2b82e'
down_revision = '06538e3ffe31'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.Column('looking_talent', sa.BOOLEAN(), autoincrement=False, nullable=True),
    ...
    sa.Column('looking_description', sa.VARCHAR(), autoincrement=False, nullable=True),
